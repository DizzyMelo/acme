...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Out-2018 às 15:26
...
CREATE TABLE `clients` (
  ...
  `clientFirstName` varchar(15) DEFAULT NULL,
  `clientLastName` varchar(25) DEFAULT NULL,
  `clientEmail` varchar(40) DEFAULT NULL,
  `clientPassword` varchar(225) DEFAULT NULL,
...
(15, 'Climbing Rope', 'This climbing rope is ideal for all uses. Each rope is the highest quality nylon and comes in 100 foot lengths.', '/acme/images/products/rope.jpg', '/acme/images/products/rope-tn.jpg', '15.00', 200, 200, 6, 'San Jose', 3, 'Marina Sales', 'Nylon'),
